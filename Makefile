...
SRC_DIRS += src src/boot src/game src/engine src/audio src/menu src/buffers actors levels bin data assets asm lib sound bin/gifs
...
$(BUILD_DIR)/bin/gifs/%.o: OPT_FLAGS := -g
