COURSE_ACTS(COURSE_BOB, _("   THE LIBRARY"),
       _("KICK OUT BOWSER")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _("   WELCOME TO THE CITY"),
       _("FIND A WAY HOME")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
...
COURSE_ACTS(COURSE_CCM, _("   A DARK PLACE"),
       _("LOOK AROUND")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
...
COURSE_ACTS(COURSE_DDD, _("   THE FOUNTAIN"),
       _("HOP IN")            , _("CHESTS IN THE CURRENT")         , _("POLE-JUMPING FOR RED COINS"),
