...
enum SeqId {
    ...
    SEQ_STREAMED_BEFORE_THE_STORY,
    SEQ_STREAMED_CITY,
    SEQ_STREAMED_BIGSHOT,
    SEQ_STREAMED_RUDE_BUSTER,
    SEQ_STREAMED_HOME,
    SEQ_STREAMED_CREEPYDOOR,
    SEQ_STREAMED_CREEPYLANDSCAPE,
    SEQ_STREAMED_THEHOLY,
    SEQ_STREAMED_DARKCITY,
    SEQ_STREAMED_DONTFORGET,
    SEQ_COUNT
};
