...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_KOOPA_WITH_SHELL, -1271, 100, 671, 0, 0, 0, 0x02010000, bhvKoopa),
		OBJECT(MODEL_BLUE_FLAME, 3119, 1340, -142, 0, 0, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, 194, 293, 16, 0, 0, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_THWOMP, 2295, 100, -529, 0, 0, 0, 0x01000000, bhvThwompCar),
		OBJECT(MODEL_SNUFIT, 28141, 2851, -31382, 0, 0, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_NONE, 2295, 100, -1800, 0, 0, 0, 0x01000000, bhvBoo),
		OBJECT(MODEL_NONE, 2295, 100, 3103, 0, 0, 0, 0x01000000, bhvBoo),
		OBJECT(MODEL_THWOMP, 2751, 100, 233, 0, 180, 0, 0x01010000, bhvThwompCar),
		OBJECT(MODEL_THWOMP, 1808, 100, -1268, 0, 180, 0, 0x01010000, bhvThwompCar),
		OBJECT(MODEL_THWOMP, 3181, 100, 918, 0, 0, 0, 0x01000000, bhvThwompCar),
		OBJECT(MODEL_THWOMP, 4080, 100, 2585, 0, 0, 0, 0x01000000, bhvThwompCar),
		OBJECT(MODEL_THWOMP, 3592, 100, 1757, 0, 180, 0, 0x01010000, bhvThwompCar),
		...
		OBJECT(MODEL_SNUFIT, 28685, 3727, -31382, 0, 0, 0, 0x00000000, bhvSnufit),
		...
		OBJECT(MODEL_SNUFIT, 27622, 3733, -31382, 0, 0, 0, 0x00000000, bhvSnufit),
