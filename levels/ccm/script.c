...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_DETERMINATION, -158, 1228, -6870, 0, 0, 0, 0x11000000, bhvBonfire),
		OBJECT(MODEL_DARK_TWOSER, -322, 52, 5225, 0, 131, 0, 0x4c000000, bhvIntroTalkBowser),
		OBJECT(MODEL_DARK_TWOSER, 489, 52, 6832, 0, -90, 0, 0x53000000, bhvIntroTalkBowser),
		...
		OBJECT(MODEL_NONE, -1, 4838, -6705, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -1, 4840, -6705),
		OBJECT(MODEL_NONE, -1, 1228, -6705, 0, 0, 0, 0x00110000, bhvSpinAirborneWarp),
